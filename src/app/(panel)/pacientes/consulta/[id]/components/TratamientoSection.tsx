...
import { searchCatalogoAction, saveTratamientoAction, deleteTratamientoAction } from "../actions";
...
export function TratamientoSection({
  ...
  async function handleAdd() {
    ...
    setSaving(false);
    if (!res?.error) {
      setItems(prev => [...prev, { id: Date.now(), nombre: selected.nombre, precio: selected.precio, moneda: selected.moneda, notas }]);
