        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 min-w-0 sm:max-w-xs lg:max-w-md relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-8 py-2 rounded-xl border border-slate-200 bg-slate-50 text-[16px] sm:text-[13px] outline-none focus:border-cyan-500 transition-colors"
            />
            {filterUsuario && (
              <button
                type="button"
