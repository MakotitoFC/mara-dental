...
export default function ConfiguracionTiposPage() {
  const [activeTab, setActiveTab] = useState<"consultas" | "archivos" | "condiciones">("consultas");
  ...
  async function loadData() {
    const [cData, aData, condData] = await Promise.all([getTiposConsultaAction(), getTiposArchivoAction(), getCondicionAction()]);
    setConsultas(cData);
    setArchivos(aData);
