...
export function WeekView({
  weekDays, citas, today, onDayClick, onEventClick, onCellClick,
}: {
  weekDays: Date[];
  citas: Cita[];
  today: Date;
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden bg-white dark:bg-slate-800">
      <div className="overflow-x-auto scroll-x-touch flex-1 min-h-0">
                      ...
                      {blocks.map(c => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <p className="text-[10.5px] font-semibold leading-tight truncate pr-2" style={{ color: tipoVars.text }}>
