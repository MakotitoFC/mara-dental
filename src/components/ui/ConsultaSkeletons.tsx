  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 items-start">
      ...
      <div className="flex flex-col gap-4">
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-4 sm:p-5 flex flex-col gap-3">
          <Skeleton className="h-3.5 w-32" />
          <Skeleton className="h-3 w-full" />
          <Skeleton className="h-3 w-3/4" />
        </div>
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-4 sm:p-5 flex flex-col gap-2.5">
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 items-start">
      {Array.from({ length: 2 }).map((_, col) => (
        <div key={col} className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
